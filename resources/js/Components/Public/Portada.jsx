    ...
    <section className="relative w-full h-[90vh] bg-black overflow-hidden font-['Nunito']">
            ...
            <div className="container mx-auto px-6 lg:px-20 grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left z-20">
                ...
                <div className="flex justify-center lg:justify-start">
                  <button className={`
                    px-12 py-5 font-black text-xs tracking-[0.2em] uppercase rounded-full transition-all flex items-center gap-3 shadow-2xl
                    ${s.isMerchantSlide 
                      ? "bg-[#0F172A] text-white border-2 border-[#F59E0B] hover:bg-[#F59E0B] hover:text-[#0F172A] hover:scale-105" 
                      : "bg-[#1E3A8A] text-white hover:bg-[#F59E0B] hover:shadow-[#F59E0B]/40 hover:-translate-y-1"}
                  `}>
                    {s.btnIcon} {s.btnText}
                  </button>
                </div>
      ...
      <div className="absolute bottom-10 left-0 w-full px-6 lg:px-20 z-40 flex items-center justify-between">
        ...
        <div className="flex gap-4">
          <button 
            onClick={prev}
            className="w-16 h-16 rounded-full backdrop-blur-xl bg-black/40 border border-white/20 flex items-center justify-center text-white hover:bg-[#F59E0B] hover:border-[#F59E0B] transition-all group shadow-2xl"
          >
